...
&emsp;&emsp;Identifies and quantifies the OOD robustness gap introduced by 4-bit PTQ in large vision backbones on resource-constrained robotic platforms, and proposes a frozen-backbone LoRA adapter trained on source data only that preserves PTQ memory savings while closing most of the robustness gap.
